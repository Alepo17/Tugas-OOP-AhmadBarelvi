...
fun myProfile() {
    ...
    val firstName: String = "NamaDepan"
    val lastName: String = "NamaBelakang"
    val age: Int = 25 // Ubah nilai sesuai umur Anda
 ...
 */
fun myTeam(): List<Any> {
    val teamMembers = listOf("Aditya", "Elfan", "Desi", "Ray","Ahmad")
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf("Aditya", "Elfan", "Desi", "Ray","Ahmad")
